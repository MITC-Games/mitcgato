...
{
{runtimeScene.getGame().getVariables().get("__CameraShake_DisplacementTravelledX").sub(gdjs.evtTools.variable.getVariableNumber(runtimeScene.getGame().getVariables().get("__CameraShake_DisplacementX")) * gdjs.evtTools.variable.getVariableNumber(runtimeScene.getVariables().get("__CameraShake_PercentTimeElapsedThisFrame")));
}{runtimeScene.getGame().getVariables().get("__CameraShake_DisplacementTravelledY").sub(gdjs.evtTools.variable.getVariableNumber(runtimeScene.getGame().getVariables().get("__CameraShake_DisplacementY")) * gdjs.evtTools.variable.getVariableNumber(runtimeScene.getVariables().get("__CameraShake_PercentTimeElapsedThisFrame")));
}}
...
{
{runtimeScene.getGame().getVariables().get("__CameraShake_AngleTravelled").add((gdjs.evtTools.variable.getVariableNumber(runtimeScene.getGame().getVariables().get("__CameraShake_DisplacementAngle")) * gdjs.evtTools.variable.getVariableNumber(runtimeScene.getVariables().get("__CameraShake_PercentTimeElapsedThisFrame"))));
}}
...
{
{runtimeScene.getGame().getVariables().get("__CameraShake_ZoomTravelled").add((gdjs.evtTools.variable.getVariableNumber(runtimeScene.getGame().getVariables().get("__CameraShake_DisplacementZoom")) * gdjs.evtTools.variable.getVariableNumber(runtimeScene.getVariables().get("__CameraShake_PercentTimeElapsedThisFrame"))));
}}
...
{
{runtimeScene.getGame().getVariables().get("__CameraShake_DisplacementTravelledX").add(gdjs.evtTools.variable.getVariableNumber(runtimeScene.getGame().getVariables().get("__CameraShake_DisplacementX")) * gdjs.evtTools.variable.getVariableNumber(runtimeScene.getVariables().get("__CameraShake_PercentTimeElapsedThisFrame")));
}{runtimeScene.getGame().getVariables().get("__CameraShake_DisplacementTravelledY").add(gdjs.evtTools.variable.getVariableNumber(runtimeScene.getGame().getVariables().get("__CameraShake_DisplacementY")) * gdjs.evtTools.variable.getVariableNumber(runtimeScene.getVariables().get("__CameraShake_PercentTimeElapsedThisFrame")));
}}
...
{
{runtimeScene.getGame().getVariables().get("__CameraShake_AngleTravelled").sub((gdjs.evtTools.variable.getVariableNumber(runtimeScene.getGame().getVariables().get("__CameraShake_DisplacementAngle")) * gdjs.evtTools.variable.getVariableNumber(runtimeScene.getVariables().get("__CameraShake_PercentTimeElapsedThisFrame"))));
}}
...
{
{runtimeScene.getGame().getVariables().get("__CameraShake_ZoomTravelled").sub((gdjs.evtTools.variable.getVariableNumber(runtimeScene.getGame().getVariables().get("__CameraShake_DisplacementZoom")) * gdjs.evtTools.variable.getVariableNumber(runtimeScene.getVariables().get("__CameraShake_PercentTimeElapsedThisFrame"))));
}}
...
{
{runtimeScene.getVariables().get("__CameraShake_PercentTimeElapsedThisFrame").setNumber(gdjs.evtTools.runtimeScene.getElapsedTimeInSeconds(runtimeScene) / gdjs.evtTools.variable.getVariableNumber(runtimeScene.getGame().getVariables().get("__CameraShake_TimeBetweenShakes")));
}}
...
gdjs.evtsExt__CameraShake__onScenePostEvents.conditionTrue_1.val = eventsFunctionContext.getOnceTriggers().triggerOnce(9155596);
}
}}
